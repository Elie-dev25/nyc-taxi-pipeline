-- ============================================================================
-- NYC TAXI PIPELINE - TABLE YELLOW CLEAN (SILVER LAYER)
-- ============================================================================
-- Description : Données Yellow Taxi nettoyées et transformées
...
-- ============================================================================
-- TABLE : YELLOW_TRIPS_CLEAN
-- ============================================================================

CREATE OR REPLACE TABLE yellow_trips_clean (
    -- IDs
    ...
    -- Catégorisation
    trip_distance_category VARCHAR(20),  -- Short, Medium, Long
    fare_category          VARCHAR(20),  -- Low, Medium, High
...
COMMENT = 'Table CLEAN pour Yellow Taxi trips - Données transformées et validées';

-- Vérifier
DESC TABLE yellow_trips_clean;

SELECT 'Table yellow_trips_clean created successfully' as status;